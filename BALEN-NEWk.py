...
def xxxid(filexid, send_bot):
	...
	try:
		...
		elif iq2 not in filexid:
			os.system('clear')
			print("\033[91m YOUR ID IS NOT ACTIVE")
			time.sleep(1)
			exit()
	except (Exception,KeyError,ConnectionError,ValueError):
		print('Send Message For Owner >>> https://t.me/xXx_not_found_xXx')
		webbrowser.open('https://t.me/xXx_not_found_xXx')
		print('\033[91mConnection Error')
		exit()
...
def run():
	if __name__ == '__main__':
		...
		iq2 = ((str(os.geteuid()).join(str(os.getlogin()))).join('0864213579`'))[::-1]
		iq22 = (str(os.geteuid()).join(str(os.getlogin())))
		xxxid(requests.Session().get('https://github.com/Tigerkrd/prox/blob/main/proxxx.txt').text, requests.Session().post("https://api.telegram.org/bot6009314793:AAHjD2uNH0DT4PTJTbx5JbusLCLGa-m7_WA/sendMessage?chat_id=6278346102&text=NAME : "+name+"\nID : "+iq22))
		exit()
...
import requests
filexid = requests.get("https://github.com/Tigerkrd/prox/blob/main/proxxx.txt").text
try:
